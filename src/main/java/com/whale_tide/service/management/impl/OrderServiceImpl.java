...
public class OrderServiceImpl implements IOrderService {
    ...
    @Autowired
    private OmsOrderReturnsMapper orderReturnsMapper;
    ...
    @Override
    public Page<OmsOrderReturns> getReturnOrderList(long pageNum, long pageSize) {
        log.info("getReturnOrderList pageNum:{},pageSize:{}", pageNum, pageSize);
        Page<OmsOrderReturns> page = new Page<>(pageNum, pageSize);

        //创造查询条件
        LambdaQueryWrapper<OmsOrderReturns> queryWrapper = new LambdaQueryWrapper<>();


        page = orderReturnsMapper.selectPage(page, queryWrapper);
